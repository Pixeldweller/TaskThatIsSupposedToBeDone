...
class EmployeesPage(StartPage):

    def __init__(self, view,db):
        StartPage.__init__(self,view,db)

    def default_view(self,feedbackmessage = ''):
        dict = self.get_employees()
        dict['msg'] = feedbackmessage
        return self.view.renderTemplateWithDictionary("employees/e_table.mako", data_op=dict)
    ...
    def show(self, num):
        ...
        if data is not None:
            ...
            return self.default_view('Datensatz nicht gefunden.')
